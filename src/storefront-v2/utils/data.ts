// Временные изображения-заглушки, позже заменим на реальные из API
const imgImage6 = "https://via.placeholder.com/400x400/FFE5E5/FF6B6B?text=Flower+1";
const imgImage7 = "https://via.placeholder.com/400x400/E5F5FF/4ECDC4?text=Flower+2";
import { Product, AddonProduct } from "../types.js";
