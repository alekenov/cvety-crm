...
import { Minus, Plus, ArrowUpDown, Edit2, Check, X } from 'lucide-react';
...
export function ProductTable({ products, onUpdateQuantity, onUpdateProduct, onShowProductDetail }: ProductTableProps) {
                ...
                >
                  <td className="p-4">
                    {editingId === product.id ? (
                      ...
                      >
                        <span className={`hover:text-primary transition-colors ${getTextClass(product)}`}>
                          {product.name}
                        </span>
