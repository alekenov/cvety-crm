...
def create_public_order(
    ...
    # Find or create customer - first try by phone only (more flexible)
    ...
    if customer:
        ...
        if order_data.recipient_name and order_data.recipient_name != "Покупатель" and customer.name != order_data.recipient_name:
            customer.name = order_data.recipient_name
            db.flush()
    else:
        # Create new customer only if none exists with this phone
        customer = Customer(
